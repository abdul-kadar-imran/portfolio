  ...
  return (
    <section className="section resume-section">
      ...
      <div className="resume-block">
        ...
        <iframe
          src="/resume/Imran__cv.pdf"
          title="Developer Resume PDF"
      ...
      <div className="resume-block">
        ...
        <div className="tag-row">
          <a className="btn primary" href="/resume/Imran_resume.pdf" download>
            Download Digital Marketing Resume
          </a>
          <a
            className="btn"
            href="/resume/Imran_resume.pdf"
            target="_blank"
            rel="noopener noreferrer"
          >
            Open in new tab
